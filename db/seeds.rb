...
quattro_formaggi = Pizza.create!(name: 'Quattro Formaggi', description: 'A four cheese combination of mozzarella and three local cheeses parmigiano-reggiano, ricotta and Gorgonzola.', price: '£8')
